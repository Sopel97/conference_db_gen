...
Record::IdType Company::countryId() const
{
    return m_countryId;
}
...
{
    return CsvRecord(std::to_string(m_companyId), m_companyName, m_contactPersonName, m_address, m_postalCode, m_city, std::to_string(m_countryId), m_phone, m_email);
}
